...
created: 2026-05-20
description: "This is now also on the Claude Blog.Markdown has become the dominant file format used by agents to communicate with us. It’s simple, porta..."
tags:
  - "clippings"
---
![画像](https://pbs.twimg.com/media/HHz_ftzaIAAwkQs?format=jpg&name=large)

**This is now also on the** [Claude Blog](https://claude.com/blog/using-claude-code-the-unreasonable-effectiveness-of-html)**.** Markdown has become the dominant file format used by agents to communicate with us. It’s simple, portable, has some rich text capability and is easy for you to edit. Claude has even gotten surprisingly good at using ASCII to make diagrams inside of markdown files.
...
![画像](https://pbs.twimg.com/media/HHz_q48aAAAaCfW?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HH0CDc6a8AAy1bv?format=png&name=large)

Claude Code trying to show color in markdown

## Visual Clarity & Ease of Reading

![画像](https://pbs.twimg.com/media/HH0AgqJbcAAaEcZ?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HH0Ao0tbYAAOF9e?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HH0BFWLbMAEk_7T?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HH0BRSQbMAAuuof?format=png&name=large)
...
![画像](https://pbs.twimg.com/media/HH0BXqjboAAHGsw?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HH0Bp86bUAAJDyZ?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HH0FbKebUAAsRPr?format=jpg&name=large)
